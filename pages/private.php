...
if (isset($_POST['action'])) {
	...
	if ($_POST['action'] == "multidel" && $_POST['delete'] && $snoop != 1) {
		...
		Alert(format("{0} deleted.", Plural($deleted, "private message")));
	}
}
...
$links = new PipeMenu();
$links -> add(new PipeMenuLinkEntry("Show received", "private", $userGet, "", "download-alt"));
$links -> add(new PipeMenuLinkEntry("Show sent", "private", $userGet, "show=1", "upload-alt"));
$links -> add(new PipeMenuLinkEntry("Show drafts", "private", $userGet, "show=2", "save"));
$links -> add(new PipeMenuLinkEntry("Send new PM", "sendprivate", "", "", "plus"));
...
$crumbs->add(new PipeMenuLinkEntry("Private messages", "private", $userGet));
	...
	<table class=\"outline margin\">
		...
		<tr class=\"header1\">
			<th style=\"text-align: right;\" colspan=\"6\">
				...
				<a href=\"javascript:void();\" onclick=\"document.forms[1].submit();\">delete checked</a>
			</th>
		</tr>
	</table>
	</font>
", (isset($_GET['show']) ? "To" : "From"), $pms);
